  ...
  var mainImageSketch = function(mainImageSketch) {
    ...
    function introSetup(){
        ...
        // console.log('intro width is: ' + introwidth);
          ...
          if(!desktop) {
            sizer =sizer / 2 * (mainImageSketch.width/mainImageSketch.height);
            cloth_width /= 2;
            cloth_particles_wide =cloth_particles_wide*mainImageSketch.round(mainImageSketch.width/mainImageSketch.height);
        }
