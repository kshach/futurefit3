...
var mainImageSketch = function(mainImageSketch) {
  ...
  new p5(mainImageSketch, document.getElementById('introContainer-mobile'));
...
new p5(soundImgSketch, document.getElementById('soundimg-mobile'));
...
new p5(noisingSketch, document.getElementById('etexsketch-mobile'));
...
new p5(fallingAttractorsSketch, document.getElementById('iotSketch-mobile'));
...
new p5(etreeSketch, document.getElementById('emotion-mobile'));
...
new p5(recraftEleSketch, document.getElementById('recraftingele-mobile'));
...
new p5(autodrawSketch, document.getElementById('autodrawsketch-mobile'));
...
var scanImgSketch = function(scnimage){
  ...
  new p5(scanImgSketch, document.getElementById('scanssketch-mobile'));
...
new p5(tdSketch, document.getElementById('touchDsketch-mobile'));
