...
var mainImageSketch = function(mainImageSketch) {
    ...
    mainImageSketch.setup = function() {
        ...
        mainImageSketch.createCanvas(mainImageSketch.windowWidth, mainImageSketch.windowHeight);
...
var fallingAttractorsSketch = function(iotAttrct) 
{
  ...
  var particles = []; 
//   let iotimgg;
// if(desktop){iotimgg = document.getElementById('iotimg');}
// else{iotimgg = document.getElementById('iotSketch-mobile');}
...
// let etreebounding;
// if(desktop){etreebounding = document.getElementById('emotionimg');}
// else {etreebounding = document.getElementById('emotion-mobile');}
...
let rnd3;
// let breakss;
// if(desktop) {breakss = document.getElementById('breaksimg');}
// else {breakss = document.getElementById('recraftingele-mobile');}
...
// let drawimg;
// if(desktop){drawimg = document.getElementById('autodrawimg');}
// else {drawimg = document.getElementById('autodrawsketch-mobile');}
...
autosk.setup = function() {
  autosk.frameRate(30);
  autosk.createCanvas(autosk.windowWidth, autosk.windowHeight, autosk.WEBGL);
...
// let scanimgsk;
// if(desktop){scanimgsk = document.getElementById('scanimg');}
//     else { scanimgsk = document.getElementById('scanssketch-mobile');}
...
//       console.log('draw width is: '+ scanwidth);
    ...
    scnimage.setup = function() {
      ...
      let scncnv = scnimage.createCanvas(scnimage.windowWidth, scnimage.windowHeight, scnimage.WEBGL);
...
var tdSketch = function(touchskch)
{
  ...
  let mousePos;
//   let tdImg;
//   if(desktop) {tdImg = document.getElementById('touchDimg');}
//   else {tdImg = document.getElementById('touchDsketch-mobile');}
