...
let desktop;
    if(window.innerWidth>991) desktop = true;
    else desktop = false;
//main image
var mainImageSketch = function(mainImageSketch) {
    ...
    let abrahamReg;
    let abrahamBlack;
    if(desktop) {let intro = document.getElementById('introContainer');}
    else{let intro = document.getElementById('introContainer-mobile');}
...
if(desktop){ let soundimgg = document.getElementById('soundimg');}
else{ let soundimgg = document.getElementById('soundimg-mobile');}
...
var noisingSketch = function(etexS) {
  ...
  if(desktop) {let img2 = document.getElementById('eteximg');}
  else {let img2 = document.getElementById('etexsketch-mobile');}
...
if(desktop){let iotimgg = document.getElementById('iotimg');}
else{ let iotimgg = document.getElementById('iotSketch-mobile');}
...
if(desktop){let etreebounding = document.getElementById('emotionimg');}
else {let etreebounding = document.getElementById('emotion-mobile');}
...
etreeskch.setup = function(){
  ...
  interStep= fr*step;
  goalRange = etreeskch.width/etreeskch.height*20;
...
if(desktop) {let breakss = document.getElementById('breaksimg');}
else {let breakss = document.getElementById('recraftingele-mobile');}
...
if(desktop){let drawimg = document.getElementById('autodrawimg');}
else {let drawimg = document.getElementById('autodrawsketch-mobile');}
...
if(desktop){  let scanimgsk = document.getElementById('scanimg');}
    else {  let scanimgsk = document.getElementById('scanssketch-mobile');}
...
var tdSketch = function(touchskch)
{
  ...
  let mousePos;
  if(desktop) {let tdImg = document.getElementById('touchDimg');}
  else {let tdImg = document.getElementById('touchDsketch-mobile');}
...
// var scanp5;
// var tdp5;
if(desktop) {var ids = ['introContainer', 'soundimg', 'eteximg', 'iotimg', 'emotionimg', 'breaksimg', 'autodrawimg', 'scanimg', 'touchDimg'];}
else {var ids = ['introContainer-mobile', 'soundimg-mobile', 'etexsketch-mobile', 'iotSketch-mobile', 'emotion-mobile', 'recraftingele-mobile', 'autodrawsketch-mobile', 'scanssketch-mobile', 'touchDsketch-mobile'];}
